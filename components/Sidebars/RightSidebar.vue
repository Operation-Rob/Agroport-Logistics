<template>
    <div class="fixed top-0 right-0 w-1/5 h-screen bg-black pl-2 py-2 pr-1 z-10 text-white">
        <div class="outline rounded-md bg-gray-950 p-2 pt-1">
        <h1 class="font-bold underline pb-2 pl-2 text-lg">Filters</h1>
        <div class="space-y-1">
        <div class="text-sm">
            Cargo:
            <select v-model="product" class="bg-gray-200 text-black text-sm px-1 rounded absolute right-2 border-2 border-gray-600 w-36">
                <option>All</option>
                <option>Urea</option>
                <option>UAN</option>
                <option>MOP</option>
        ...
        <div class="text-sm">
            Origin Country:
            <select v-model="originCountry" class="bg-gray-200 text-black text-sm px-1 rounded absolute right-2 border-2 border-gray-600 w-36">
                <option>All</option>
        ...
        <div class="text-sm">
            Dest. Country:
            <select v-model="destCountry" class="bg-gray-200 text-black px-1 text-sm rounded absolute right-2 border-2 border-gray-600 w-36">
                <option>All</option>
